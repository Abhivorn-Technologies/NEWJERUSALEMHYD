    ...
    return (
      <div className="min-h-screen bg-[#e8f1f3] py-8 px-4 md:px-8 font-sans">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row w-full max-w-3xl mx-auto shadow-sm rounded-2xl border-2 border-[#bcd3d8]/50 focus-within:border-[#5795A7] transition-all bg-white hover:shadow-md">
