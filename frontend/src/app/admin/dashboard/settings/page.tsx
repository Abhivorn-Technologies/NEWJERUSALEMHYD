    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            <label className="block text-sm text-gray-800 mb-2">Site Name</label>
            <input 
              required 
              type="text" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm text-gray-800 mb-2">Primary Phone</label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block text-sm text-gray-800 mb-2">Secondary Phone</label>
              <input 
                type="text" 
          ...
          <div>
            <label className="block text-sm text-gray-800 mb-2">Public Contact Email</label>
            <input 
              type="email" 
          ...
          <div>
            <label className="block text-sm text-gray-800 mb-2">Physical Address</label>
            <textarea 
              rows={3} 
          ...
          <div>
            <label className="block text-sm text-gray-800 mb-2">Footer Tagline</label>
            <textarea 
              rows={2} 
