      ...
      <div className="w-full max-w-md px-4 relative z-10">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="pt-8 pb-4 px-8 flex flex-col items-center border-b border-gray-50 bg-gray-50/50">
            {/* Logo */}
            <div className="w-[90%] h-24 relative mb-2">
              <Image 
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-[#D04A73]/20 focus:border-[#D04A73] transition-all duration-200 outline-none text-[#4D1C2C] font-medium"
