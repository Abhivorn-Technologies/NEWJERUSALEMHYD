...
export default function MinistryDetails() {
  return (
    <div className="w-full select-none">
      ...
      <section className="bg-[#003138] pt-4 pb-16 text-white">
        <div className="max-w-7xl mx-auto px-6 space-y-4">
          ...
          <div className="text-center space-y-2.5 max-w-2xl mx-auto">
            <p 
              className="text-[#FFEBB3] italic font-bold text-sm sm:text-base md:text-lg lg:text-[22px] tracking-wide"
              style={{ fontFamily: 'var(--font-roboto)' }}
            >
              1 కొరింథి 4 : 20 , రోమా 14 : 17
            </p>
            <div 
              className="space-y-1 text-white/95 text-[13px] sm:text-base md:text-lg lg:text-[20px] leading-relaxed font-[500]"
              style={{ fontFamily: 'var(--font-tenali)' }}
            >
              <p>“దేవుని రాజ్యము మాటలతో కాదు శక్తి తోనే యున్నది.</p>
              <p>దేవుని రాజ్యము భోజనమును పానమును కాదు గాని,</p>
              <p>నీతియు సమాధానమును, పరిశుద్ధాత్మయందలి ఆనందమునై యున్నది.”</p>
            </div>
          </div>
          ...
          <div 
            className="text-[13px] sm:text-base md:text-lg lg:text-[21px] leading-relaxed font-[400] text-gray-200 text-center space-y-6"
            style={{ fontFamily: 'var(--font-tenali)' }}
          >
            <p>
            ...
            <p className="text-[#FFEBB3] font-semibold tracking-wide">
          ...
          <div className="pt-2">
            <div 
              ...
              style={{ fontFamily: 'var(--font-tenali)' }}
            >
              <p className="text-[13px] sm:text-base md:text-lg lg:text-[21px] leading-relaxed font-[400] text-gray-700">
              ...
              <p className="text-gray-900 font-extrabold text-[14px] sm:text-lg md:text-xl lg:text-[22px] tracking-wide">
